...
def parse_args():
  ...
  parser.add_argument('--vis', dest='vis',
                      ...
                      action='store_true')
  parser.add_argument('--model_path', type=str, default='./data/out')
...
if __name__ == '__main__':
  ...
  load_name_list = os.listdir(args.model_path)

  for load_name_file in load_name_list:
    load_name = os.path.join(args.model_path, load_name_file)
    if '.pth' not in load_name_file:
      print("ignore %s" % (load_name_file))
      continue

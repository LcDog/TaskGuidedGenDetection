...
from torch.autograd import Variable
import numpy as np
from model.utils.config import cfg as cfg_default
...
class _fasterRCNN(nn.Module):
    ...
    def __init__(self, classes, class_agnostic, cfg=cfg_default):
        ...
        self.RCNN_roi_pool = _RoIPooling(self.cfg.POOLING_SIZE, self.cfg.POOLING_SIZE, 1.0/16.0)
